...
class OllamaClient:
    ...
    """
    def __init__(self, base_url="http://localhost:11434", resource_governor=None):
        self.base_url = base_url
        self.resource_governor = resource_governor

    @retry_api_call(max_retries=3, initial_backoff=1.0)
    def generate_content(self, prompt, system_instruction=None, model="llama3.2:3b", image_path=None, **kwargs):
